# EEP_ComputeAnimalOps.py
#
# Description:
#   Computes the number of animal operation points within each NHD Catchment. 
...
animalopsFC = arcpy.GetParameterAsText(1)   #
...
arcpy.Intersect_analysis("{} #;{} #".format(catchmentFC,animalopsFC),xingsFC,"NO_FID","","POINT")
...
arcpy.AlterField_management(outputTbl,"FREQUENCY","AnimalOps","Animal operations")
